...
export const themes: HMITheme[] = [
  {
    ...
    colors: {
      ...
      foreground: hsl(225, 18, 94),
      mutedForeground: hsl(225, 10, 63),
  ...
  },
  {
    ...
    colors: {
      ...
      foreground: hsl(0, 5, 94),
      mutedForeground: hsl(0, 5, 63),
      primary: hsl(0, 72, 51),
  ...
  },
  {
    ...
    colors: {
      ...
      foreground: hsl(200, 20, 94),
      mutedForeground: hsl(200, 12, 62),
